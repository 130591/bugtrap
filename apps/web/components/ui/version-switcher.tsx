		...
		<SidebarMenuItem>
			<DropdownMenu>
				<DropdownMenuTrigger asChild>
					<SidebarMenuButton
						size="lg"
						 className="bg-transparent hover:bg-[#2A2B2E] text-white hover:text-white data-[state=open]:bg-[#2A2B2E] data-[state=open]:text-white px-3 py-2 transition-colors"
					>
				...
				<DropdownMenuContent
					align="start"
					className="w-72 p-2 space-y-2 bg-[#18191C] text-white border border-[#2A2B2E]"
				>
					<div className="p-3 bg-[#1F2023] rounded-md flex items-center gap-2">
					...
					<div className="flex justify-between gap-2">
						<button className="flex items-center gap-2 px-3 py-2 text-sm bg-[#1F2023] hover:bg-[#2A2B2E] text-white rounded-md w-full">
					...
					<div className="p-3 bg-[#1F2023] rounded-md space-y-1">
						<DropdownMenuItem className="group bg-transparent hover:bg-[#2A2B2E] text-white hover:text-white px-3 py-2 transition-colors">
						...
						<DropdownMenuItem className="group bg-transparent hover:bg-[#2A2B2E] text-red-400 hover:text-red-400 px-3 py-2 transition-colors">
