...
import { FilteringParams } from '../decorator/param.decorator'
import { RESPONSE_FILTERING_INFO_KEY } from '../response.constants'
import { FilteringDto, FilteringQueryOperation } from '../dto/filtering.dto'
import { FilteredResponseOptions } from '../decorator/response.decorators'
import { FilteringQueryDto } from '../dto/filtering-query'
...
export async function validateFilteringQuery(
  ...
  const filteringInfo = new FilteringDto(filteringOptions)
